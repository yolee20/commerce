package com.itstar.commons.utils
...
object DateUtils {
  ...
  def getDateHour(datetime:String):String = {
    ...
    /*val hour2 = datetime.split(" ")(1).split(":")(0)
    data+"_"+hour2*/
  }
  ...
  def main(args: Array[String]): Unit = {
    print(DateUtils.parseTime("2018-10-31 20:27:53"))
  }
...
object NumberUtils {
  ...
  /**
    * 格式化小数  参数的详解：https://blog.csdn.net/well386/article/details/53945796
    * @param scale 四舍五入的位数
    * @return 格式化小数
    */
